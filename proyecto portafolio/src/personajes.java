...
public class personajes {
    ...
    */
    ...
    public boolean vivo()
    {
        ...
        System.out.println("la carta: " + this.getNombre()+ " ha muerto");
        return flag;
    ...
    public void golpe(int _poder)
    {
        ...
        {
          vidaRest-= daño;
         System.out.println("la carta: "+this.getNombre() + "ha resivido " + daño + " puntos de daño");
         
        } else {
            System.out.println("Bueno vamo' a juga'");
        }
        this.setVida(vidaRest);
        System.out.println("a la carta : " +this.getNombre() +" le quedan"+ vidaRest +" puntos de vida.");
        /*
